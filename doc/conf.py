...
# ROSify Sphinx configuration file
import os
...
copyright = u'2020, TU Delft and stakeholders of \'Collaborating and coupled AGV swarms with extended environment recognition\' project under EIT Manufacturing funding.'
