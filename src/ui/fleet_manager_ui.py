...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeWidgetJobs.setIndentation(0)
        self.treeWidgetJobs.setObjectName(_fromUtf8("treeWidgetJobs"))
        self.treeWidgetJobs.header().setVisible(True)
        self.treeWidgetJobs.header().setDefaultSectionSize(80)
        self.treeWidgetJobs.header().setMinimumSectionSize(65)
        self.treeWidgetJobs.header().setStretchLastSection(True)
